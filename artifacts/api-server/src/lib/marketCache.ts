...
const FALLBACK_MARKETS: MarketInfo[] = [
  { index: 1, symbol: "BTC-USDC", baseAsset: "BTC", quoteAsset: "USDC", type: "perp", sizeDecimals: 5, priceDecimals: 1, minBaseAmount: 0, minQuoteAmount: 0, lastTradePrice: 0, dailyPriceChange: 0, dailyVolume: 0, dailyVolumeQuote: 0, dailyHigh: 0, dailyLow: 0 },
  { index: 2, symbol: "ETH-USDC", baseAsset: "ETH", quoteAsset: "USDC", type: "perp", sizeDecimals: 4, priceDecimals: 2, minBaseAmount: 0, minQuoteAmount: 0, lastTradePrice: 0, dailyPriceChange: 0, dailyVolume: 0, dailyVolumeQuote: 0, dailyHigh: 0, dailyLow: 0 },
  { index: 3, symbol: "SOL-USDC", baseAsset: "SOL", quoteAsset: "USDC", type: "perp", sizeDecimals: 2, priceDecimals: 3, minBaseAmount: 0, minQuoteAmount: 0, lastTradePrice: 0, dailyPriceChange: 0, dailyVolume: 0, dailyVolumeQuote: 0, dailyHigh: 0, dailyLow: 0 },
];
